...
const experiencias = [
    {
        id: 1,
        NomeExperiencia: "Administração de olímpiada de Geografia escolar",
    ...
    },
    {
        ...
        Experiencia:`No terceiro ano do ensino médio, elaborei um projeto sobre a produção de um documentário. Como um dos criadores do projeto, assumi o papel de líder. Ao longo do ano, minha equipe se desfez, deixando-me sozinho para reconstruir o projeto. Consequentemente, tive que refazer as entrevistas e desempenhar os papéis de entrevistador, cinegrafista e editor. Obtive acesso a entrevistas com pessoas mais influentes, porém com pessoas mais simples também, o que me fez ter que remodelar a forma com que conversava com cada um. Consegui cumprir o prazo estabelecido, mesmo tendo menos tempo para fazê-lo, e, por conseguinte, adquiri habilidades em conversação e organizar. \n\n`
    }
];
